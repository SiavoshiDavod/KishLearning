...
namespace AdobeConnectSDK.Model
{
  ...
  public class PrincipalListItem
  {
    ...
    public class PrincipalListItemViewModel: PrincipalListItem
    {
        public string AccountIdVm=> AccountId;
        public string PrincipalIdVm=> PrincipalId;
        public bool HasChildrenVm=> HasChildren;
        public bool IsHiddenVm=> IsHidden;
        public bool IsPrimaryVm=> IsPrimary;
        public string LoginVm=> Login;
        public string NameVm=> Name;
        public string EmailVm=> Email;
        public string DisplayUidVm=> DisplayUid;
    }
  ...
  public class PrincipalSetup
  {
    ...
    public class PrincipalSetupViewModel 
    {
    ...
    public class PrincipalSetupGroupViewModel
    {
