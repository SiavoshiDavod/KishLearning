...
namespace FaraPayamak
{
    public class Send
    {
        ...
        private readonly static string userName = "fereidoonrezaei";
        private readonly static string pass = "55674694";
        private readonly static string HeadNumber = "50004000504110";
        private FaraPayamak.SendSMS.SendSoapClient GetService()
        {
            try
            {
                ...
                return new FaraPayamak.SendSMS.SendSoapClient(binding1, endpointAdress);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public double GetCredit()
        {
            ...
            {
                var sms = GetService();
                return sms.GetCredit(userName, pass);
            }
            catch (Exception)
            {
                return 0;
        ...
        public async Task<Tuple<bool, string, long, string>> send(string phoneNumber, string content)
        {
            ...
            SendSMS.SendSmsResponse retvalObj = await sms.SendSmsAsync(new SendSMS.SendSmsRequest(userName, pass, new string[] { phoneNumber }, HeadNumber, content, false, "", rec, status));
            rec = retvalObj.recId;
            ...
            switch (retval)
            {
                ...
                case 1:
                    ...
                    {
                        return new Tuple<bool, string, long, string>(true, message, recId, HeadNumber);
                    }
                    break;
                case 2:
            ...
            return new Tuple<bool, string, long, string>(false, message, recId, HeadNumber);
