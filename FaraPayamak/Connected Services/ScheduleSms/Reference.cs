...
namespace FaraPayamak.ScheduleSms {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ScheduleSms.ScheduleSoap")]
    public interface ScheduleSoap {
        ...
        int AddSchedule(string username, string password, string to, string from, string text, bool isflash, System.DateTime scheduleDateTime, FaraPayamak.ScheduleSms.PeriodType period);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/AddSchedule", ReplyAction="*")]
        System.Threading.Tasks.Task<int> AddScheduleAsync(string username, string password, string to, string from, string text, bool isflash, System.DateTime scheduleDateTime, FaraPayamak.ScheduleSms.PeriodType period);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        int AddNewUsance(string username, string password, string to, string from, string text, bool isflash, System.DateTime scheduleStartDateTime, int countrepeat, System.DateTime scheduleEndDateTime, FaraPayamak.ScheduleSms.PeriodType periodType);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/AddNewUsance", ReplyAction="*")]
        System.Threading.Tasks.Task<int> AddNewUsanceAsync(string username, string password, string to, string from, string text, bool isflash, System.DateTime scheduleStartDateTime, int countrepeat, System.DateTime scheduleEndDateTime, FaraPayamak.ScheduleSms.PeriodType periodType);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        FaraPayamak.ScheduleSms.ScheduleDetails GetScheduleDetails(string username, string password, int scheduleId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/GetScheduleDetails", ReplyAction="*")]
        System.Threading.Tasks.Task<FaraPayamak.ScheduleSms.ScheduleDetails> GetScheduleDetailsAsync(string username, string password, int scheduleId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/AddMultipleSchedule", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        int[] AddMultipleSchedule(string username, string password, string[] to, string from, string[] text, bool isflash, System.DateTime[] scheduleDateTime, FaraPayamak.ScheduleSms.PeriodType period);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/AddMultipleSchedule", ReplyAction="*")]
        System.Threading.Tasks.Task<int[]> AddMultipleScheduleAsync(string username, string password, string[] to, string from, string[] text, bool isflash, System.DateTime[] scheduleDateTime, FaraPayamak.ScheduleSms.PeriodType period);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ScheduleSoapChannel : FaraPayamak.ScheduleSms.ScheduleSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ScheduleSoapClient : System.ServiceModel.ClientBase<FaraPayamak.ScheduleSms.ScheduleSoap>, FaraPayamak.ScheduleSms.ScheduleSoap {
        ...
        public int AddSchedule(string username, string password, string to, string from, string text, bool isflash, System.DateTime scheduleDateTime, FaraPayamak.ScheduleSms.PeriodType period) {
            return base.Channel.AddSchedule(username, password, to, from, text, isflash, scheduleDateTime, period);
        }
        
        public System.Threading.Tasks.Task<int> AddScheduleAsync(string username, string password, string to, string from, string text, bool isflash, System.DateTime scheduleDateTime, FaraPayamak.ScheduleSms.PeriodType period) {
        ...
        public int AddNewUsance(string username, string password, string to, string from, string text, bool isflash, System.DateTime scheduleStartDateTime, int countrepeat, System.DateTime scheduleEndDateTime, FaraPayamak.ScheduleSms.PeriodType periodType) {
        ...
        public System.Threading.Tasks.Task<int> AddNewUsanceAsync(string username, string password, string to, string from, string text, bool isflash, System.DateTime scheduleStartDateTime, int countrepeat, System.DateTime scheduleEndDateTime, FaraPayamak.ScheduleSms.PeriodType periodType) {
        ...
        public FaraPayamak.ScheduleSms.ScheduleDetails GetScheduleDetails(string username, string password, int scheduleId) {
            return base.Channel.GetScheduleDetails(username, password, scheduleId);
        }
        
        public System.Threading.Tasks.Task<FaraPayamak.ScheduleSms.ScheduleDetails> GetScheduleDetailsAsync(string username, string password, int scheduleId) {
            return base.Channel.GetScheduleDetailsAsync(username, password, scheduleId);
        }
        
        public int[] AddMultipleSchedule(string username, string password, string[] to, string from, string[] text, bool isflash, System.DateTime[] scheduleDateTime, FaraPayamak.ScheduleSms.PeriodType period) {
            return base.Channel.AddMultipleSchedule(username, password, to, from, text, isflash, scheduleDateTime, period);
        }
        
        public System.Threading.Tasks.Task<int[]> AddMultipleScheduleAsync(string username, string password, string[] to, string from, string[] text, bool isflash, System.DateTime[] scheduleDateTime, FaraPayamak.ScheduleSms.PeriodType period) {
