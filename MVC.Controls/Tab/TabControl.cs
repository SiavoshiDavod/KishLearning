...
namespace MVC.Controls.Tab
{
    public class TabControl
    {
        ...
        /// <returns></returns>
        public TabControl SetAjaxOptions(string ajaxOptions) { this.AjaxOptions = ajaxOptions; return this; }
        ...
        public string Render(HtmlHelper htmlHelper)
        {
            ...
            if (!string.IsNullOrEmpty(this.OnSelect))
                sb.Append(", activate: function (event, ui){return " + this.OnSelect + "(event, ui);}");
            ...
            if(!string.IsNullOrEmpty(this.AjaxOptions))
                sb.Append(",ajaxOptions: {").Append(this.AjaxOptions).Append("}");
