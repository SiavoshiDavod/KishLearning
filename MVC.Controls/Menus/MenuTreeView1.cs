...
{
    public static class MenuTreeView1Helper
    {
        /// <summary>
        /// Create an HTML tree from a recursive collection of items
        /// </summary>
        public static MenuTreeView1<T> MenuTreeView1<T>(this HtmlHelper html, string TreeId, string SelectedMainMenuId)
        {
            return new MenuTreeView1<T>(html, TreeId, SelectedMainMenuId);
        }
    }
    ...
    /// </summary>
    public class MenuTreeView1<T> : IHtmlString
    {
        ...
        public MenuTreeView1(HtmlHelper html, string TreeId, string SelectedMainMenuId)
        {
        ...
        /// </summary>
        public MenuTreeView1<T> ItemText(Func<T, string> selector)
        {
        ...
        /// </summary>
        public MenuTreeView1<T> ItemTemplate(Func<T, HelperResult> itemTemplate)
        {
        ...
        /// <returns></returns>
        public MenuTreeView1<T> ShowContextMenu(bool showContextMenu)
        {
            this._showContextMenu = showContextMenu;
            return this;
        }
        public MenuTreeView1<T> ShowCheckbox(bool showCheckbox)
        {
            this._isCheckbox = showCheckbox;
            this._isCheckboxTwoState = false;
            return this;
        }
        public MenuTreeView1<T> ShowCheckbox(bool showCheckbox, bool isTwoState)
        {
            this._isCheckbox = showCheckbox;
            this._isCheckboxTwoState = isTwoState;
            return this;
        }
        public MenuTreeView1<T> ShowCRRM(bool showCRRM)
        {
            this._showCRRM = showCRRM;
            return this;
        }
        public MenuTreeView1<T> ContextMenu(string contextMenu)
        {
            this.contextMenu = contextMenu;
            return this;
        }
        public MenuTreeView1<T> showContextCreate(bool showCreate, string functionName)
        {
            this._cShowCreate = showCreate;
            this.cCreateFunctionName = functionName;
            return this;
        }
        public MenuTreeView1<T> showContextEdit(bool showEdit, string functionName)
        {
            this._cShowEdit = showEdit;
            this.cEditFunctionName = functionName;
            return this;
        }
        public MenuTreeView1<T> AjaxLoadContent(bool _ajaxLoadContent)
        {
            this._ajaxLoadContent = _ajaxLoadContent;
            return this;
        }
        public MenuTreeView1<T> LanguageDirection(string langDirection)
        {
            this._langDirection = langDirection;
            return this;
        }

        public MenuTreeView1<T> showContextRemove(bool showRemove, string functionName)
        {
            this._cShowRemove = showRemove;
            this.cRemoveFunctionName = functionName;
            return this;
        }
        public MenuTreeView1<T> OnSelect(string onSelect)
        {
            this._onSelect = onSelect;
            return this;
        }
        public MenuTreeView1<T> CheckedNodes(string checkedNodes)
        {
        ...
        /// </summary>
        public MenuTreeView1<T> Children(Func<T, IEnumerable<T>> selector)
        {
            if (selector == null) throw new ArgumentNullException("selector");
        ...
        /// </summary>
        public MenuTreeView1<T> EmptyContent(string emptyContent)
        {
        ...
        /// </summary>
        public MenuTreeView1<T> HtmlAttributes(object htmlAttributes)
        {
        ...
        /// HTML attributes appended to the root ul node
        /// </summary>
        public MenuTreeView1<T> HtmlAttributes(IDictionary<string, object> htmlAttributes)
        {
        ...
        /// </summary>
        public MenuTreeView1<T> ChildrenHtmlAttributes(object htmlAttributes)
        {
        ...
        /// HTML attributes appended to the children items
        /// </summary>
        public MenuTreeView1<T> ChildrenHtmlAttributes(IDictionary<string, object> htmlAttributes)
        {
            if (htmlAttributes == null) throw new ArgumentNullException("htmlAttributes");
        ...
        /// <returns></returns>
        public MenuTreeView1<T> TreeJsonModel(TreeJsonModel TreeJsonModel)
        {
        ...
        private string generateJsTree(string MenuTreeId, string menuData)
        {
          ...
          // jsBuilder.Append("\t\t\t\"plugins\": [\"themes\", \"json_data\",\"crrm\", \"contextmenu\",\"dnd\",\"ui\",\"cookies\"");
            ...
            if (_isCheckbox)
            {
                jsBuilder.Append(",\"checkbox\",\"wholerow\"");
            }
            if (_showContextMenu)
            {
           ...
           if (_isCheckboxTwoState)
           {
            ...
            jsBuilder.Append(string.IsNullOrEmpty(menuData)?"[]":menuData);
            //jsBuilder.AppendLine("]");
            jsBuilder.AppendLine("\t\t\t\t\t}");
            ...
            jsBuilder.Append("\t\t})");
            jsBuilder.AppendLine("\t\t.on(\"select_node.jstree\", function (e, data) {");
            jsBuilder.AppendLine("\t\t\tif(data.event.which==1){");
            jsBuilder.AppendLine("\t\t\t\tdocument.location = data.instance.get_node(data.node, true).children('a').attr('href');");
            jsBuilder.AppendLine("\t\t\t}");
            jsBuilder.AppendLine("\t\t});");
