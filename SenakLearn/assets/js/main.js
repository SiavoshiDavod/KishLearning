...
function changeSlider(id) {
    var clas = $('.' + id).children()[0].id;
    var color = $('#' + clas + "Color").val()
    $('#mainpreTitleForchangingSlider').html($('#' + clas + "preTitle").val());
    $('#mainTitleForchangingSlider').html($('#' + clas + "Title").val());
    $('#mainDescriptionForchangingSlider').html($('#' + clas + "Description").val());
    $("#mainpreTitleForchangingSlider").css('color', color);
    $("#mainTitleForchangingSlider").css('color', color);
    $("#mainDescriptionForchangingSlider").css('color', color);
}
$(function() {
	...
	$(".rslides-header").responsiveSlides({
        ...
        nav: true,
        after: function () {
            changeSlider(this.namespace + "1_on");
        }
	});
