...
namespace SenakLearn.Controllers
{
    public class BaseController : Controller
    {
        ...
        internal bool RemoveFile(string fileName, pathFile path)
        {
            try
            {
                if (System.IO.File.Exists(Server.MapPath("/images/" + path + "/" + fileName)))
                {
                    System.IO.File.Delete(Server.MapPath("/images/" + path + "/" + fileName));
                    return true;
                }
                else
                    return false;
        ...
        protected override void OnException(ExceptionContext filterContext)
        {
            ...
            if (Request.IsAjaxRequest())
            {
                ...
                else
                {
                    ...
                    //filterContext.HttpContext.Response.Status = innerEx.Message;
                    //filterContext.HttpContext.Response.StatusDescription = innerEx.Message;
                    filterContext.HttpContext.Response.ContentType = "text/rtf; charset=UTF-8";
                    filterContext.HttpContext.Response.Charset = "UTF-8";
                    filterContext.HttpContext.Response.Write(innerEx.Message);
                    ...
                    //}
                    filterContext.Result = new ContentResult() { Content= innerEx.Message };
                }
            ...
            if (!regex.IsMatch(innerEx.Message))
            {
                ...
                try
                {
                    ...
                    {
                        streamWriter.WriteLine(System.DateTime.Now.ToString() + " " + innerEx.Message + " " + ExceptionExtensions.GetStackTraceWithMessage(innerEx));
        ...
        //[NonAction]
        //public FileContentResult PrintStiToPdf(StiReport report, string fileName)
        //{
        //    report.Render(false);
        ...
        //    result.FileDownloadName = "Order_" + DateTime.Now.ToShortDateString() + ".pdf";

        //    Response.Headers.Add("ContentType", "application/pdf; charset=utf-8");
        //    //Response.Headers.Add("ContentEncoding", "");
        //    Response.Headers.Add("Content-Length", stream.Length.ToString());
        //    //Content-Disposition header set to inline along with file name for download
        //    Response.Headers.Add("Content-Disposition", ("inline; filename= Order_" + DateTime.Now.ToShortDateString() + ".pdf"));
        //    var fileStream = new FileContentResult(stream.ToArray(), "application/pdf")
        //    {
        //        FileDownloadName = "Order_" + fileName + ".pdf",
