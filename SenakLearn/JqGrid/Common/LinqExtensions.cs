...
namespace SenakLearn.JqGrid.Common
{
    public static class LinqExtensions
    {
        ...
        public static IQueryable<T> Where<T>(this IQueryable<T> query,
            string column, object value, global::SenakLearn.JqGrid.Common.WhereOperation operation)
        {
            ...
            {
                //equal ==
                case global::SenakLearn.JqGrid.Common.WhereOperation.Equal:
                    condition = Expression.Equal(MemberExpression.Convert(memberAccess,
                                            memberAccessType), filter);
                    lambda = Expression.Lambda(condition, parameter);
                    break;
                //not equal !=
                case global::SenakLearn.JqGrid.Common.WhereOperation.NotEqual:
                    condition = Expression.NotEqual(MemberExpression.Convert(memberAccess,
                                            memberAccessType), filter);
                    lambda = Expression.Lambda(condition, parameter);
                    break;
                //string.Contains()
                case global::SenakLearn.JqGrid.Common.WhereOperation.Contains:
