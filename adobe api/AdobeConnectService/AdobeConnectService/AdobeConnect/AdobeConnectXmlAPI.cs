    ...
    public sealed class AdobeConnectXmlAPI
    {
        ...
        public AdobeConnectXmlAPI(ICommunicationProvider communicationProvider, ISdkSettings settings)
        {
            ...
            if (settings.httpClient == null)
                throw new ArgumentNullException("Argument 'httpClient' can not be null.");
        ...
        ///   <see cref="UserInfo" />
        /// </returns>
        public UserInfoStatus UserInfo
        {
            get
            {
        ...
        internal ApiStatus ScoUpdate(MeetingUpdateItem meetingUpdateItem, out MeetingDetail meetingDetail)
        {
            ...
            meetingDetail.ScoId
                ...
                throw new Exception("Adobe-AdobeConnectXmlAPI-ScoUpdate", ex.InnerException ?? ex);
                //throw ex.InnerException;
            }
