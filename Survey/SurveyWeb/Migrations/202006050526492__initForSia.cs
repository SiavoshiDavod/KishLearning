namespace SurveyWeb.Migrations
{
    ...
    public partial class _initForSia : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        AdvertisingId = c.Int(nullable: false),
                        CreatedDate = c.DateTime(nullable: false),
                        UpdateDate = c.DateTime(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Advertisings", t => t.AdvertisingId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Cartables", t => t.CartableId, cascadeDelete: false)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Cartables", t => t.CartableId, cascadeDelete: true)
                .ForeignKey("dbo.Resturants", t => t.ResturantId)
                .Index(t => t.CartableId)
                .Index(t => t.ResturantId);
                ...
                c => new
                    {
                        ...
                        side_content_Desc = c.String(maxLength: 400),
                        side_content_Title = c.String(maxLength: 100),
                        side_content_SubTitle = c.String(maxLength: 100),
                        Poshtibani247 = c.String(maxLength: 200),
                        WorkingHours = c.String(maxLength: 200),
                        Footer_AboutUs = c.String(maxLength: 200),
                        Footer_AboutUsLink = c.String(maxLength: 200),
                        Footer_ServiceLink = c.String(maxLength: 200),
                        Footer_WebLogLink = c.String(maxLength: 200),
                        Footer_LegalLink = c.String(maxLength: 200),
                        Footer_PoliticsLink = c.String(maxLength: 200),
                        Footer_MobileTel = c.String(maxLength: 200),
                        Footer_CopyRight = c.String(maxLength: 200),
                        Banner_Title1 = c.String(maxLength: 200),
                        Banner_Description1 = c.String(maxLength: 500),
                        Banner_Title2 = c.String(maxLength: 200),
                        Banner_Description2 = c.String(maxLength: 500),
                        Banner_Title3 = c.String(maxLength: 200),
                        Banner_Description3 = c.String(maxLength: 500),
                        Banner_Btn1 = c.String(maxLength: 200),
                        Banner_LinkBtn1 = c.String(maxLength: 200),
                        Banner_Btn2 = c.String(maxLength: 200),
                        Banner_LinkBtn2 = c.String(maxLength: 200),
                        Banner_Btn3 = c.String(maxLength: 200),
                        Banner_LinkBtn3 = c.String(maxLength: 200),
                        Banner_Btn4 = c.String(maxLength: 200),
                        Banner_LinkBtn4 = c.String(maxLength: 200),
                        Banner_Btn5 = c.String(maxLength: 200),
                        Banner_LinkBtn5 = c.String(maxLength: 200),
                        Banner_Btn6 = c.String(maxLength: 200),
                        Banner_LinkBtn6 = c.String(maxLength: 200),
                    })
                .PrimaryKey(t => t.Id);
