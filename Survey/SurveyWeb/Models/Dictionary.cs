...
namespace SurveyWeb.Models
{
    public enum Permisstion
    {
        ...
        [Description("کارتابل مراکزپذیرایی")]
        Resturants,
        [Description("نوع مراکزپذیرایی")]
        ResturantTypes,
        [Description("نوع مدارک پیوست")]
        CheckListTypes,
        [Description("کاربران درانتظار تایید")]
        ResturantUsers,
        [Description("مراکزپذیرایی")]
        CheckListTypeCartables,
        [Description("تبلیغات")]
        Advertisings,
        [Description("تایید موقعیت های شغلی")]
        AdminJobPosition,
        [Description("تایید پروفایل کارجو")]
        AdminEmployeeProfile,
        [Description("منوی مراکزپذیرایی")]
        ResturantMenus,
        [Description("شکایت مراکزپذیرایی")]
        Shekayats,
        [Description("تنظيمات پرداخت مراکزپذیرایی")]
        PaymentTypes,
        [Description("پرداختي هاي مراکزپذیرایی")]
        ResturantPayments,
        ...
        CheckListGroup,
        [Description("تعریف ارزیابی")]
        CheckList,
        [Description("ارزیابی")]
        ComplaintCheckList,
        [Description("نوع کمپانی")]
        CompanyTypes,
        [Description("دسته بندی کاریابی")]
        JobCategorys,
        [Description("هیأت مدیره")]
        BoardDirectors,
    ...
    public static class Dictionary
    {
        public static Dictionary<Type, string> ModelDictionary = new Dictionary<Type, string> {
            ...
            { typeof(UserComment),"نظرات کاربران"},
             ...
             { typeof(Resturant)," کارتابل مراکزپذیرایی"},
             { typeof(ResturantType),"نوع مراکزپذیرایی"},
             { typeof(CheckListType),"نوع مدارک پیوست"},
             { typeof(CheckListTypeCartable),"مراکزپذیرایی"},
             { typeof(Advertising),"تبلیغات"},
             { typeof(ResturantMenu),"منوی مراکزپذیرایی"},
             { typeof(Resturan.Shekayat),"شکایت مراکزپذیرایی"},
             { typeof(Resturan.PaymentType),"تنظيمات پرداخت مراکزپذیرایی"},
             { typeof(Resturan.ResturantPayment),"پرداختي هاي مراکزپذیرایی"},
             { typeof(CheckList.CheckListGroup),"عنوان ارزیابی"},
             { typeof(CheckList.CheckList),"تعریف بازدید"},
             { typeof(CheckList.ComplaintCheckList),"بازدید"},
             { typeof(BaseInfo.Education),"تحصیلات"},
             { typeof(BaseInfo.City),"شهر"},
             { typeof(BaseInfo.CompanyType),"نوع شرکت"},
             { typeof(JobBoard.JobCategory),"دسته بندی کاریابی"},
             { typeof(JobBoard.JobPosition),"تایید موقعیت های شغلی"},
             { typeof(JobBoard.EmployeeProfile),"تایید پروفایل کارجو"},
             { typeof(BoardDirector),"هیأت مدیره"},
             { typeof(EmailSms),"اطلاع رسانی"},
             { typeof(Ticket),"تیکت"},
        };
