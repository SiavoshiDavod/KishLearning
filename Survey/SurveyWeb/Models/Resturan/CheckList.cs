...
namespace SurveyWeb.Models
{
    ...
    public enum CartableCheckListType 
    {
        [Description("کارکنان")]
        Personels= 1000000001,
        //[Description("پیوست ها")]
        //Attachement,

        [Description("اطلاعات مرکزپذیرایی")]
        Resturant= 1000000002,

        [Description("مشخصات بهره بردار")]
        Beneficiary = 1000000003,
        [Description("مشخصات مدیر")]
        Manager = 1000000004,
        //[Description("مشخصات نیروی انسانی")]
        //Personel = 1000000005,
        [Description("مشخصات منو و خدمات")]
        Menu = 1000000006,
        [Description("مشخصات آشپزخانه")]
        Chicken = 1000000007,
        [Description("مشخصات دیگر")]
        Other = 1000000008,
    }
