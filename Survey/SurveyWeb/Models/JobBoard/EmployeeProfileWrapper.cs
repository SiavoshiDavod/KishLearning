...
using System.Linq;
using System.Web;
using static SurveyWeb.Models.JobBoard.EmployeeProfile;

namespace SurveyWeb.Models.JobBoard
{
    public class EmployeeProfileWrapper : BaseEntity
    {
        ...
        public ICollection<EducationalBackground> EducationalBackground { get; set; }
