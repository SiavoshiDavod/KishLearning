        ...
        public static readonly List<PermissionParentChild> PermissionParentChildStaticList = new List<PermissionParentChild>()
        {
            new PermissionParentChild()
            {
                ...
                Childs=new List<PermissionParentChild>()
                {
                    new PermissionParentChild()
                    {
                         Description=Dictionary.ModelDictionary[typeof(SurveyWeb.Models.BaseInfo.City)],
                         Permisstion=Permisstion.Citys
                    },
                    new PermissionParentChild()
                    {
                         Description=Dictionary.ModelDictionary[typeof(SurveyWeb.Models.BaseInfo.Education)],
                         Permisstion=Permisstion.Educations
                    },
                    new PermissionParentChild()
                    {
                         Description=Dictionary.ModelDictionary[typeof(SurveyWeb.Models.BaseInfo.CompanyType)],
                         Permisstion=Permisstion.CompanyTypes
                    },new PermissionParentChild()
                    {
                    ...
                    {
                         Description=Dictionary.ModelDictionary[typeof(JobBoard.JobCategory)],
                         Permisstion=Permisstion.JobCategorys
                    },
                }
            },
            new PermissionParentChild()
            {
                ...
                { new PermissionParentChild()
                    {
                         Description=Dictionary.ModelDictionary[typeof(SurveyWeb.Models.User)],
                         Permisstion=Permisstion.ResturantUsers
                    },
                    new PermissionParentChild()
                    {
                         Description=Dictionary.ModelDictionary[typeof(SurveyWeb.Models.CheckListTypeCartable)],
                         Permisstion=Permisstion.CheckListTypeCartables
                    }, new PermissionParentChild()
                    {
                    ...
                    {
                         Description=Dictionary.ModelDictionary[typeof(SurveyWeb.Models.ResturantMenu)],
                         Permisstion=Permisstion.ResturantMenus
                    }
                    ,new PermissionParentChild()
                    {
                         Description=Dictionary.ModelDictionary[typeof(SurveyWeb.Models.Resturan.Shekayat)],
                         Permisstion=Permisstion.Shekayats
                    }  ,new PermissionParentChild()
                    {
                         Description=Dictionary.ModelDictionary[typeof(EmailSms)],
                         Permisstion=Permisstion.Notifications
                    },new PermissionParentChild()
                    {
                         Description=Dictionary.ModelDictionary[typeof(Ticket)],
                         Permisstion=Permisstion.Tickets
                    }
                }
            },
            new PermissionParentChild()
            {
                Description="امورمالی",
                Childs=new List<PermissionParentChild>()
                {
                   new PermissionParentChild()
                    {
                         Description=Dictionary.ModelDictionary[typeof(SurveyWeb.Models.Resturan.PaymentType)],
                         Permisstion=Permisstion.PaymentTypes
                    }
                    ,new PermissionParentChild()
                    {
                         Description=Dictionary.ModelDictionary[typeof(SurveyWeb.Models.Resturan.ResturantPayment)],
                         Permisstion=Permisstion.ResturantPayments
                    }
                }
            },
            new PermissionParentChild()
            {
                ...
                Childs=new List<PermissionParentChild>()
                {
                    new PermissionParentChild()
                    {
                         Description=Dictionary.ModelDictionary[typeof(SurveyWeb.Models.Advertising)],
                         Permisstion=Permisstion.Advertisings
                    },
            ...
            new PermissionParentChild()
            {
                ...
                Childs=new List<PermissionParentChild>()
                {
                    new PermissionParentChild()
                    {
                         Description=Dictionary.ModelDictionary[typeof(SurveyWeb.Models.JobBoard.JobPosition)],
                         Permisstion=Permisstion.AdminJobPosition
                    },
                    new PermissionParentChild()
                    {
                         Description=Dictionary.ModelDictionary[typeof(SurveyWeb.Models.JobBoard.EmployeeProfile)],
                         Permisstion=Permisstion.AdminEmployeeProfile
                    },
                    new PermissionParentChild()
                    {
                         Description=Dictionary.ModelDictionary[typeof(SurveyWeb.Models.JobBoard.JobCategory)],
                         Permisstion=Permisstion.JobCategorys
                    },
                }
            },
            ...
            new PermissionParentChild()
            {
                ...
                Childs=new List<PermissionParentChild>()
                {
                    ...
                    new PermissionParentChild()
                    {
                         Description=Dictionary.ModelDictionary[typeof(SurveyWeb.Models.BoardDirector)],
                         Permisstion=Permisstion.BoardDirectors
                    }, new PermissionParentChild()
                    {
            ...
            new PermissionParentChild()
            {
                ...
                Childs=new List<PermissionParentChild>()
                {
                    ...
                    new PermissionParentChild()
                    {
                        Description=Dictionary.ModelDictionary[typeof(SurveyWeb.Models.CheckList.CheckListGroup)],
                        Permisstion=Permisstion.CheckListGroup
                    },
                    new PermissionParentChild()
                    {
                        Description=Dictionary.ModelDictionary[typeof(SurveyWeb.Models.CheckList.CheckList)],
                        Permisstion=Permisstion.CheckList
                    },
                    new PermissionParentChild()
                    {
                        Description=Dictionary.ModelDictionary[typeof(SurveyWeb.Models.CheckList.ComplaintCheckList)],
                        Permisstion=Permisstion.ComplaintCheckList
                    },
                }
            },
            new PermissionParentChild()
