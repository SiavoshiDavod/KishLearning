...
H.setOptions({
    lang: {
        ...
        accessibility: {
            ...
            screenReaderRegionLabel: 'اطلاعات خواننده صفحه نمودار.',
            defaultChartTitle: 'نمودار',
            viewAsDataTable: 'نمایش جدولی.',
            chartHeading: 'نمودار گرافیکی.',
            chartContainerLabel: '{title}. نمودار تعاملی.',
            svgContainerLabel: 'نمودار تعاملی',
            rangeSelectorMinInput: 'انتخاب اولین تاریخ.',
            rangeSelectorMaxInput: 'انتخاب آخرین تاریخ.',
            tableSummary: 'نمایش جدول نمودار.',
            mapZoomIn: 'بزرگ نمایی',
            mapZoomOut: 'کوچک نمایی',
            resetZoomButton: 'نمایش سایز اصلی',
            drillUpButton: '{buttonText}',
            rangeSelectorButton: 'انتخاب محدوده {buttonText}',
            legendLabel: 'تغییر وضعیت نمایش ردیف',
            legendItem: 'تغییر وضعیت نمایش {itemName}',
