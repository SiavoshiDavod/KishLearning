...
namespace SurveyWeb.Models
{
    public enum Permisstion
    {
        ...
        [Description("تبلیغات")]
        Advertisings,
        [Description("منوی رستوران")]
        ResturantMenus,
        [Description("شکایت رستوران")]
        Shekayats,
        [Description("تنظيمات پرداخت رستوران")]
        PaymentTypes,
        [Description(" پرداختي هاي رستوران")]
        ResturantPayments,
    ...
    public static class Dictionary
    {
        public static Dictionary<Type, string> ModelDictionary = new Dictionary<Type, string> {
            ...
            { typeof(UserComment),"نظرات کاربران"},
             ...
             { typeof(ResturantMenu),"منوی رستوران"},
             { typeof(Resturan.Shekayat),"شکایت رستوران"},
             { typeof(Resturan.PaymentType),"تنظيمات پرداخت رستوران"},
             { typeof(Resturan.ResturantPayment),"پرداختي هاي رستوران"},
