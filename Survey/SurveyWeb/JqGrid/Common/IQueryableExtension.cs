...
namespace SurveyWeb.JqGrid.Common
{
    public static class IQueryableExtension
    {
        ...
        public static IQueryable<T> FilterAndSortJqGrid<T>(this IQueryable<T> query, GridSettings gridSettings)
        {
                ...
                if (gridSettings.Where.groupOp == "AND")
                    foreach (var rule in gridSettings.Where.rules)
                        ...
                        query = query.Where<T>(
                            ...
                            (global::SurveyWeb.JqGrid.Common.WhereOperation)global::SurveyWeb.JqGrid.Common.StringEnum.Parse(typeof(global::SurveyWeb.JqGrid.Common.WhereOperation), rule.op));
                else
                {
                    //Or
            ...
            {
                query = global::SurveyWeb.JqGrid.Common.LinqExtensions.OrderBy<T>(query, (string) gridSettings.SortColumn,
