...
namespace SurveyWeb.Controllers
{
    public class BaseAdminController : BaseController
    {
        ...
        protected override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            if (filterContext.HttpContext.Request.IsAuthenticated)
            {
                ...
                try
                {
                    ...
                    if (Current_learn_user.RoleId != Roles.User && Biz.UserBiz.Instance.IsAccess(p, Current_learn_user.Id))
                    {
                        SetViewBagMenu(Current_learn_user);
                        base.OnActionExecuting(filterContext);
                        return;
        ...
        private void SetViewBagMenu(User Current_learn_user)
        {
            ...
            if (Current_User.RoleId == Roles.Admin || Current_User.RoleId == Roles.SuperAdmin)
            {
