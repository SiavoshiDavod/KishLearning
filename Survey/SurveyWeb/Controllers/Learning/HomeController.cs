...
namespace SenakLearn.Controllers
{
    public class HomeController : BaseController
    {
        ...
        public ActionResult ShowAllClasses(int? groupId, int? teacherId, string keyword)
        {
            ViewBag.groupId = groupId;
        ...
        public ActionResult Cours(int? groupId, int? teacherId, string keyword)
        {
            ...
            ViewBag.teacherId = teacherId;
            ViewBag.keyword = keyword;
            var cours = _db.learn_cours.Where(i => i.status && (groupId == null || groupId == i.id_group) && (teacherId == null || teacherId == i.id_teacher) && (string.IsNullOrEmpty(keyword) || i.name.Contains(keyword))).ToList();
