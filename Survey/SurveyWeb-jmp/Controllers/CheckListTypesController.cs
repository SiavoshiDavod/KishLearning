...
namespace SurveyWeb.Controllers
{
    public class CheckListTypesController : BaseAdminController
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,DropDownTitle")] CheckListType checkListType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,DropDownTitle")] CheckListType checkListType)
        {
            if (ModelState.IsValid)
            {
