...
namespace SenakLearn.Controllers
{
    public class ZarinpalController : BaseController
    {
        ...
        {
            var user = zarinpalBiz.Instance.Callback(Status, Authority, out string message);
            if (user == null)
            {
            ...
            else
            {
                ...
                await Biz.UserBiz.Instance.SendToAdminAsync(user, false,true);
                return Redirect("/MyClass/Index");
            }
